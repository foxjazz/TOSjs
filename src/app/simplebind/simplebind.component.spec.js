...
describe('SimplebindComponent', function () {
    it('should have print "Simple" on template', testing_1.async(testing_1.inject([testing_1.TestComponentBuilder], function (tsb) {
